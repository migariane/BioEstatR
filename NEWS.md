...
*   Inclusión de referencias científicas (`@references`) para todas las funciones exportadas, facilitando la consulta de literatura estadística fundamental.
*   Cobertura de pruebas unitarias (`testthat`) para todas las funciones exportadas.
*   Actualización de la viñeta introductoria.

## BioStatR 1.0.0 (2026-05-29)
...
*   Soporte para instalación desde GitHub y archivos locales.
*   Incluye documentación básica y viñeta introductoria.
